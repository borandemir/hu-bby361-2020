<?php
    ...
    $CdninKonumBilgisi = mysqli_real_escape_string($baglanti, $_POST['CdninKonumBilgisi']);
    $KonumDerecesi = mysqli_real_escape_string($baglanti, $_POST['KonumDerecesi']);

    $sorgu = "UPDATE konum SET KonumKayitNo = '$KonumKayitNo', 	CdninKonumBilgisi = '$CdninKonumBilgisi', KonumDerecesi = '$KonumDerecesi' WHERE KonumKayitNo  = $KonumKayitNo";
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
    <ul class="navbar-nav ">
      ...
      <li class="nav-item">
        ...
        <p><a href="listele.php">Katalog Listesine dön...</a></p>
