    ...
    <ul class="navbar-nav ">
      ...
      <li class="nav-item">
       ...
       <center>  <h1>Konum Ekle</h1> </center>
        ...
        <form action="konumEkleB.php" method="post">
             <label for="ad">Cd nin Konum Bilgisi :</label><br/>
            <input type="text" name="CdninKonumBilgisi" style="color:black"><br>
			
            <label for="ad">Konum Derecesi:</label><br/>
            <input type="text" name="KonumDerecesi" style="color:black"><br>
