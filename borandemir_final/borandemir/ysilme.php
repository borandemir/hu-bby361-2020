<?php
    ...
    $silinecek = mysqli_real_escape_string($baglanti, $_GET["YonetmenKayitNo"]);
    $sorgu = "DELETE FROM yönetmen WHERE YonetmenKayitNo = '$silinecek'";
