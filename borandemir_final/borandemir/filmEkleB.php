<?php
    ...
    $sorgu = "INSERT INTO film (FilmAdi, Vizyon, YonetmenKayitNo, Dil, Kategori, KonumKayitNo,filmAciklama)
            VALUES ('$FilmAdi','$Vizyon', '$YonetmenKayitNo', '$Dil',  '$Kategori', '$KonumKayitNo', '$filmAciklama')";




    if (mysqli_query($baglanti, $sorgu)) {
        $islemSonuc = "Yeni film kaydı Başarıyla Oluşturuldu.";
    } else {
    ...
    <ul class="navbar-nav ">
      ...
      <li class="nav-item">
       ...
       <center> <h1>Film Ekle</h1> </center>
        ...
        <p><a href="filmEkle.php">Yeni bir film ekle!</a></p>
             <p><a href="listele.php">Anasayfaya dön...</a></p>  </div>
