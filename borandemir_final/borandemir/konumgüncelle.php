<?php
    ...
    $guncellenecek = mysqli_real_escape_string($baglanti, $_GET["KonumKayitNo"]);
    $sorgu = mysqli_query($baglanti, "SELECT * FROM konum WHERE KonumKayitNo  = $guncellenecek");
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
    <ul class="navbar-nav ">
      ...
      <li class="nav-item">
        ...
        <center> <h1>Konum Güncelle</h1> </center>
        <form action="konumgüncelleB.php" method="post">
			<label for="ad">Cdnin Konum Bilgisi:</label><br/>
            <input type="text" value="<?php echo $satir["CdninKonumBilgisi"] ;?>" name="CdninKonumBilgisi" style="color:black "><br>
            
			<label for="ad">Konum Derecesi:</label><br/>
            <input type="text" value="<?php echo $satir["KonumDerecesi"] ;?>" name="KonumDerecesi" style="color:black "><br>

            <input type="hidden" value="<?php echo $satir["KonumKayitNo"] ;?>" name="KonumKayitNo">
