...
$sorgu = "INSERT INTO yönetmen (YonetmenAdi, YonetmenSoyadi, DogumTarihi, Nereli, BaskaFilmler, YonetmenUrl)
        VALUES ('$YonetmenAdi', '$YonetmenSoyadi','$DogumTarihi', '$Nereli', '$BaskaFilmler', '$YonetmenUrl')";
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
    <ul class="navbar-nav ">
     ...
     <center> <h1>Yönetmen Ekle</h1> </center>
        ...
        <p><a href="yönetmenEkle.php">Yeni bir yönetmen ekle!</a></p> 
